...
int main() {
    SimpleCommKitWebSocketServer server;
    ...
    std::cout << "=== SimpleCommKit WebSocket Server ===" << std::endl;
    ...
    // TLS
    std::string useTls;
    std::cout << "Use TLS/SSL (wss://)? (y/n) [n]: ";
    ...
    // Start server
    // ---------------------------------------------------------------
    std::cout << "Starting WebSocket server on " << host << ":" << port << " ..." << std::endl;
